...
/* ------------------------------------------------------------------------- */
/* OBS: A função lib_bwcheck() foi movida para a classe biblio.js            */
/* ------------------------------------------------------------------------- */
...
oCMenu.barcolor="#cddef5" //The color of the background bar - Value: "color"
oCMenu.barwidth="779" // 779-oCMenu.barx //The width of the background bar. Set this to "menu" if you want it to be the same width as the menu. (this will change to match the border if you have one) - Value: px || "%" || "menu"
...
oCMenu.fromtop=44 //This is the left position of the menu. (Only in use if menuplacement below is 0 or aligned) (will change to adapt any borders) - Value: px || "%"
...
oCMenu.level[0].width=190 //The default width for each level[0] (top) items. You can override this on each item by spesifying the width when making the item. - Value: px || "%"
...
oCMenu.level[0].bgcoloroff="#cddef5" //The default background color for each level[0] (top) items. You can override this on each item by spesifying the backgroundcolor when making the item. - Value: "color"
oCMenu.level[0].bgcoloron="#999999" //The default "on" background color for each level[0] (top) items. You can override this on each item by spesifying the "on" background color when making the item. - Value: "color"
...
// menu arrows
// cmTopMenuImage='&nbsp;&nbsp;&nbsp;<img src="./biblioteca/imagens/Darrow.gif">'
// cmSubMenuImage='&nbsp;&nbsp;&nbsp;<img src="./biblioteca/imagens/Rarrow.gif">'
