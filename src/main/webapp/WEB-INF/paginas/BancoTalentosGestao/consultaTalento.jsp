        ...
        <table class="listagem">
                    ...
                    <aa:zone name="aaTalentos" >
                        <logic:present name="lstCategoriaAtributosTalentoConsulta">
                                    ...
                                    <tr class="<%= cor0 %>">
                                        ...
                                        <td colspan="4">
                                            ...
                                            <logic:equal name="objCategoriaAtributoTalentoConsulta" property="atributoTalento.tipoHTML.descricao" value="SELECT-MULTIPLE">
                                                <html:select property="<%= strAtributoConsulta %>" style="width:705" multiple="true">
                                                    <html:option value="">&nbsp;</html:option>
                                                    <logic:present name="<%= strAtributoTalentoOpcao %>">
                                                        <html:options collection="<%= strAtributoTalentoOpcao %>" labelProperty="descricao" property="identificador"/>
                                                    </logic:present>
											...
											<logic:present name="objCategoriaAtributoTalentoConsulta" property="atributoTalento.descricaoPesquisa">
												<logic:equal name="objCategoriaAtributoTalentoConsulta" property="atributoTalento.indicativoPesquisa" value="S">
													<a href="JavaScript:void(0);"><img src="<%=request.getContextPath()%>/biblioteca/imagens/paginas/lupa.gif" onclick="javascript:openPopUp('/' + obterContextPath() + '/BancoTalentosGestao/consultaAtributoTalentoOpcaoPrepararVisualizacao.do?categoriaAtributoTalento=<%= intIdeCategoriaAtributoTalentoConsulta %>', splitAtributo, 620, 500)" title="<bean:write name="objCategoriaAtributoTalentoConsulta" property="atributoTalento.descricaoPesquisa"/>" border="0"></a>
												</logic:equal> 
											</logic:present>
											<logic:notPresent name="objCategoriaAtributoTalentoConsulta" property="atributoTalento.descricaoPesquisa">
												<logic:equal name="objCategoriaAtributoTalentoConsulta" property="atributoTalento.indicativoPesquisa" value="S">
													<a href="JavaScript:void(0);"><img src="<%=request.getContextPath()%>/biblioteca/imagens/paginas/lupa.gif" onclick="javascript:openPopUp('/' + obterContextPath() + '/BancoTalentosGestao/consultaAtributoTalentoOpcaoPrepararVisualizacao.do?categoriaAtributoTalento=<%= intIdeCategoriaAtributoTalentoConsulta  %>', splitAtributo, 620, 500)" title="Selecionar" border="0"></a>
												</logic:equal> 
											</logic:notPresent>
                		            		&nbsp;
                                        </td>
                            ...
                            <center style="background-color: white;"> 
                                <br />
                                <html:submit onclick="avisarProcessamento(); document.forms[0].action='consultaTalentoAdicionarCriterio.do'">Adicionar</html:submit>
                                <br />&nbsp;
                            </center>
                        </logic:present>
                    </aa:zone>
            ...
            <logic:present name="mapConsultasTalento">
                    ...
                    <% //if ("S".equals(strPreenchimentoMap)) { %>
                        <br>
                        <center> 
                            <html:submit onclick="avisarProcessamento(); document.forms[0].action='resultadoConsultaTalentoEfetuarConsulta.do'">Consultar</html:submit>
                        </center>
                    <% //} %>
            </logic:present>
    </logic:present>
