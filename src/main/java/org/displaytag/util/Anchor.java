...
public class Anchor
{
    ...
    public String getOpenTag()
    {
        ...
        {
            return TagConstants.TAG_OPEN + TagConstants.TAGNAME_ANCHOR + getHrefString() + getOnclickString() + TagConstants.TAG_CLOSE;
        }
        ...
        buffer.append(getOnclickString());
    ...
    {
        if (this.href.getOnclick() != null)
            return " onclick=\"" + this.href.getOnclick() + "\"";
