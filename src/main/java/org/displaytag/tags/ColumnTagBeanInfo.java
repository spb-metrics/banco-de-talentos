...
public class ColumnTagBeanInfo extends SimpleBeanInfo
{
    ...
    public PropertyDescriptor[] getPropertyDescriptors()
    {
        ...
        try
        {
            ...
            proplist.add(new PropertyDescriptor("hrefType", //$NON-NLS-1$
            ColumnTag.class, null, "setHrefType")); //$NON-NLS-1$             
            proplist.add(new PropertyDescriptor("titleAlign", //$NON-NLS-1$
            ColumnTag.class, null, "setTitleAlign")); //$NON-NLS-1$
            proplist.add(new PropertyDescriptor("onclick", //$NON-NLS-1$
            ColumnTag.class, null, "setOnclick")); //$NON-NLS-1$            
            proplist.add(new PropertyDescriptor("export", //$NON-NLS-1$
            ColumnTag.class, null, "setExport")); //$NON-NLS-1$            
