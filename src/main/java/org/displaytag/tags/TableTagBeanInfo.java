...
public class TableTagBeanInfo extends SimpleBeanInfo
{
    ...
    public PropertyDescriptor[] getPropertyDescriptors()
    {
        ...
        try
        {
            ...
            // SIGESP
            proplist.add(new PropertyDescriptor("totalRecords", //$NON-NLS-1$
                    TableTag.class, null, "setTotalRecords")); //$NON-NLS-1$
            // SIGESP
            proplist.add(new PropertyDescriptor("pageParamName", //$NON-NLS-1$
                    TableTag.class, null, "setPageParamName")); //$NON-NLS-1$            
