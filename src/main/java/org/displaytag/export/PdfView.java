 ...
 */
public class PdfView extends BinaryExportView
{
    ...
    {
        this.tablePDF = new Table(this.model.getNumberOfColumns(true));
        this.tablePDF.getDefaultLayout().setVerticalAlignment(Element.ALIGN_TOP);
    ...
    public void doExport(OutputStream out) throws JspException
    {
        try
        {
            ...
            HeaderFooter footer = new HeaderFooter(new Phrase(TagConstants.EMPTY_STRING, this.smallFont), true);
    ...
    protected void generateRows() throws JspException, BadElementException
    {
        ...
        while (rowIterator.hasNext())
        {
            ...
            while (columnIterator.hasNext())
            {
                ...
                Cell cell = this.getCell(super.escapeColumnValue(value));
