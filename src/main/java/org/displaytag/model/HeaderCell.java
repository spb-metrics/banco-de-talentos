...
public class HeaderCell
{
    ...
    /**
     * Propriedade que indica se a coluna em questão pode (true -> default) ou não (false) ser gerada na exportação.
     */
    ...
    /**
     * setter for the hrefType attribute
     * 
     * @param strHrefType
     * @version SIGESP
     */
    public void setHrefType(String strHrefType)
    {
        this.strHrefType = strHrefType;
    }

    /**
     * @see #setHrefType(String)
     * @version SIGESP
     */
    public String getHrefType()
    {
        return this.strHrefType;
    }
