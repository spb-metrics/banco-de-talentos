...
public class SmartListHelper
{
    ...
    /**
     * 
     * @see #SmartListHelper(List, int, int, TableProperties)
     * @version SIGESP
     */
    public SmartListHelper(List list, int fullsize, int itemsInPage, TableProperties tableProperties, int totalRecords)
    {
    	this(list, fullsize, itemsInPage, tableProperties);
    	
        if (totalRecords > 0)
        {
            this.fullListSize = totalRecords;
        }
    ...
    protected List getListForPage(int pageNumber)
    {
        ...
        // SIGESP
        /*int firstIndex = getFirstIndexForPage(pageNumber) % this.pageSize;
        int lastIndex = getLastIndexForPage(pageNumber) % this.pageSize;
        ...
        if (totalRecords == 0)
        {
            list = new ArrayList(this.pageSize + 1);
            int firstIndex = getFirstIndexForPage(pageNumber);
    ...
    public String getPageNavigationBar(Href baseHref, String pageParameter)
    {
        ...
        // SIGESP deixa apenas pagina como parametro
        //baseHref.setParameterMap(new HashMap());
