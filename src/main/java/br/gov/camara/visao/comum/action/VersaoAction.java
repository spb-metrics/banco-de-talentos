...
package br.gov.camara.visao.comum.action;
...
import br.gov.camara.visao.comum.sequencia.VersaoSequencia;
...
public final class VersaoAction extends SigespAction
{
    // Inicializa o log

    private static Log log = LogFactory.getLog(VersaoAction.class);
            ...
            HttpServletResponse response)
    {
        ...
        try
        {
            ...
            VersaoSequencia versaoSequencia = new VersaoSequencia (mapping, form, request, response, (ActionMessages) mapMensagens.get(ActionMessagesUtil.CHAVE_REQUEST_ERROS), (ActionMessages) mapMensagens.get(ActionMessagesUtil.CHAVE_REQUEST_MENSAGENS), this, mapRecursos);
        	
        // Efetuar as operacoes do mapeamento '/versaoPrepararVisualizacao'
        
        if ("/versaoPrepararVisualizacao".equals(mapping.getPath()))
        {
        
            // Efetuar a operacao referente ao mapeamento '/versaoPrepararVisualizacao'
            arlMensagens = versaoSequencia.versaoPrepararVisualizacao();
        }
