...
/**
 * ActionForm DetalheFiltroConsultaGrupoForm
 *
 * @version FALTA DOCUMENTACAO
 * @author FALTA DOCUMENTACAO
 */

public final class DetalheFiltroConsultaGrupoForm extends ActionForm
{
    // Inicializa o log
     ...
     * 
     */
    private static final long serialVersionUID = -3585445880337803883L;

    private static Log log = LogFactory.getLog(DetalheFiltroConsultaGrupoForm.class);
    ...
    */
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request)
    {
        ...
        /*if ("DetalheFiltroConsultaGrupo".equals(mapping.getParameter()))
        {
