...
/**
 * ActionForm OrdenacaoCategoriaTalentoForm
 *
 * @version FALTA DOCUMENTACAO
 * @author FALTA DOCUMENTACAO
 */

public final class OrdenacaoCategoriaTalentoForm extends ActionForm
{
    // Inicializa o log

    private static Log log = LogFactory.getLog(OrdenacaoCategoriaTalentoForm.class);
            ...
            HttpServletRequest request)
    {
        ...
        if ("OrdenacaoCategoriaTalento".equals(mapping.getParameter()))
        {
