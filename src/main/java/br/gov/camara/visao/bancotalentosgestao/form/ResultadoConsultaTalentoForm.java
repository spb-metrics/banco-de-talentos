...
/**
 * ActionForm ResultadoConsultaTalentoForm
 *
 * @version FALTA DOCUMENTACAO
 * @author FALTA DOCUMENTACAO
 */

public final class ResultadoConsultaTalentoForm extends ActionForm
{
    // Inicializa o log

    private static Log log = LogFactory.getLog(ResultadoConsultaTalentoForm.class);
            ...
            HttpServletRequest request)
    {
        ...
        if ("ResultadoConsultaTalento".equals(mapping.getParameter()))
        {
