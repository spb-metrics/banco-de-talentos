...
/**
 * ActionForm ConsultaTalentoForm
 *
 * @version FALTA DOCUMENTACAO
 * @author FALTA DOCUMENTACAO
 */

public final class ConsultaTalentoForm extends ActionForm
{
    // Inicializa o log

    private static Log log = LogFactory.getLog(ConsultaTalentoForm.class);
    ...
    private String criterioConsulta = null;
    ...
    {
        return (this.criterioConsulta);
    }

    /**
     * FALTA DOCUMENTACAO
     *
     * @param criterioConsulta FALTA DOCUMENTACAO
     */
     ...
     * FALTA DOCUMENTACAO
     *
     * @param tipoConsulta FALTA DOCUMENTACAO
     */
            ...
            HttpServletRequest request)
    {
        ...
        if ("ConsultaTalento".equals(mapping.getParameter()))
        {
