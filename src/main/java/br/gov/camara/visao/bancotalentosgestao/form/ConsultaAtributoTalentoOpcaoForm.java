...
/**
 * ActionForm ConsultaAtributoTalentoOpcaoForm
 *
 * @version FALTA DOCUMENTACAO
 * @author FALTA DOCUMENTACAO
 */

public final class ConsultaAtributoTalentoOpcaoForm extends ActionForm
{
    // Inicializa o log

    private static Log log = LogFactory.getLog(ConsultaAtributoTalentoOpcaoForm.class);

    // Propriedades (variaveis de intancia) -----------------------------------

    private String atributoTalentoOpcao = null;
    ...
    public String getAtributoTalentoOpcao()
    {
        return (this.atributoTalentoOpcao);
    }

    /**
     * FALTA DOCUMENTACAO
     *
     * @param atributoTalentoOpcao FALTA DOCUMENTACAO
     */

    public void setAtributoTalentoOpcao(String atributoTalentoOpcao)
    {
            ...
            HttpServletRequest request)
    {
        ...
        if ("ConsultaAtributoTalentoOpcao".equals(mapping.getParameter()))
        {
