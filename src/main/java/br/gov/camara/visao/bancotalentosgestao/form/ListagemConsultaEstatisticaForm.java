...
/**
 * ActionForm ListagemConsultaEstatisticaForm
 *
 * @version FALTA DOCUMENTACAO
 * @author FALTA DOCUMENTACAO
 */

public final class ListagemConsultaEstatisticaForm extends ActionForm
{
    // Inicializa o log

    private static Log log = LogFactory.getLog(ListagemConsultaEstatisticaForm.class);

    // Propriedades (variaveis de intancia) -----------------------------------

    private String[] idePessoa = null;
    ...
    {
        return (this.idePessoa);
    }

    /**
     * FALTA DOCUMENTACAO
     *
     * @param idePessoa FALTA DOCUMENTACAO
     */
            ...
            HttpServletRequest request)
    {
        ...
        if ("ListagemConsultaEstatistica".equals(mapping.getParameter()))
        {
